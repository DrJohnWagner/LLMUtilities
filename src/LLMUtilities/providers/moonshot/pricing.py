...
class MoonshotChatPricing(BaseModel):
...
class MoonshotChatUsageDetails(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class MoonshotChatCostDetails(BaseModel):
    model_config = ConfigDict(extra="forbid")
    ...
    total_cost: float
    currency: str
    provider: Literal["moonshot"] = "moonshot"
    requested_model: Optional[str] = None
    resolved_model: str


def list_pricings() -> list[MoonshotChatPricing]:
    return load_pricing_catalogue(PRICING_PATH, MoonshotChatPricing)
...
def get_pricing(
    ...
    return select_pricing(
        list_pricings(), model, provider_name="moonshot", effective_at=effective_at
    )
...
def calculate_cost_summary(
    *,
    usage: MoonshotChatUsageDetails,
    pricing: MoonshotChatPricing,
...
def calculate_cost_details(
    *,
    ...
    return MoonshotChatCostDetails(
